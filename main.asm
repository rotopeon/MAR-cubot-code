; HEADER - Constants by hackersoup with help of many contributors ; https://github.com/simon987/Much-Assembly-Required/wiki/Snippet:-Constants ;
*************************** Hardware IDs 
HWID_LEGS     equ 0x1 
HWID_LASER    equ 0x2 
HWID_LIDAR    equ 0x3 
...
; END OF HEADER 
.text 	
MOV A, KEYBOARD_FETCH_KEY 	HWI HWID_KEYBOARD         
MOV A, LEGS_SET_DIRECTION_AND_WALK 
; prepare for movement 
CMP B, KEY_W 	JZ north 	
CMP B, KEY_S 	JZ south 	
CMP B, KEY_A 	JZ west 	
CMP B, KEY_D 	JZ east 	
CMP B, KEY_E 	JZ drill 	
CMP B, KEY_I 	JZ inventory 	
CMP B, KEY_C 	JZ inventory_clear 	
CMP B, KEY_F 	JZ laser_biomass 
end:     
